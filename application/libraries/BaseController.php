...
class BaseController extends CI_Controller {
	 ...
	 */
	function paginationCompress($link, $count, $perPage = 25) {
		...
		// print_r("seg check=".SEGMENT);
		// print_r(" seg=".$segment);
		// //print_r(" count=".$count);
		
		// print_r(" perpage=".$perPage);
		// print_r("len =".strlen($segment));
	...
	function paginationCompressid($link, $count, $perPage = 25) {
		$this->load->library ( 'pagination' );
		...
		$this->pagination->initialize ( $config );
		$page = $config ['per_page'];
	    $segment = $this->uri->segment(SEGMENT_ID);
