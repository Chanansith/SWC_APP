<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> รายงานค่าใช้จ่าย
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-dashboard"></i> รายงานค่าใช้จ่าย</a></li>
        </ol>
    </section>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">รายงานค่าใช้จ่าย</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" id="reportCost" action="<?php echo base_url() ?>reportCostList" method="post" role="form">
                        <div class="box-body">
