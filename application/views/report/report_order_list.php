...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('order') ?>"> Report Order</a></li>
            <li><a href="<?= base_url('order') ?>"> Report Order List</a></li>
        </ol>
    </section>
        ...
        <!-- <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addOrder"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div> -->
        <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        manageTable = $('#manageTable').DataTable({
            // "ajax": {
            //     "url": "<?= base_url() ?>report/fetchDataReportOrderList",
            //     "data": function(d) {
            //         // Additional data to send with the request can be added here
