...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> รายงานค่าซ่อม
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-dashboard"></i> รายงานค่าซ่อม</a></li>
        </ol>
    </section>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">รายงานค่าซ่อม</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" id="reportCost" name="reportCost" action="<?php echo base_url() ?>reportFixList" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div id="monthInput" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  " readonly id="model" name="model" autocomplete="off" placeholder="Click to Search" data-toggle="modal" data-target="#searchModal">
                                    <input type="hidden" class="form-control " id="carno" name="carno" autocomplete="off">
                                </div>
                                <div class="form-group">
                            ...
                            <div id="yearInput" style="display: none;">
                                <div class="form-group">
                                    <label for="model">รถ</label>
                                    <input type="text" class="form-control required " readonly id="modelyear" name="modelyear" autocomplete="off" placeholder="Click to Search" data-toggle="modal" data-target="#searchModal">
                                    <input type="hidden" class="form-control required" id="carnoyear" name="carnoyear" autocomplete="off">
                                </div>
                                <div class="form-group">
