...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> สัญญาจัดเก็บมูลฝอยติดเชื้อ:Contract for disposal IMW กับ ขนส่ง 
            <small>Add</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">สัญญาจัดเก็บมูลฝอยติดเชื้อ:Contract for disposal IMW+Transport</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" id="addContract" action="<?php echo base_url_api ?>contract/create_transport" method="post" role="form" >
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
