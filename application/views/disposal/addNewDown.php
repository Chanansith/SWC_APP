                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" readonly id="registerno" name="registerno" autocomplete="off" data-toggle="modal" data-target="#searchModal">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">ชื่อ</label>
                                        <input type="text" class="form-control required" readonly id="name" name="name" autocomplete="off" data-toggle="modal" data-target="#searchModal">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="down">ยอดดาว</label>
                                        <input type="text" class="form-control required"  id="down" name="down" autocomplete="off">
                                    </div>
                                </div>
                            </div>
