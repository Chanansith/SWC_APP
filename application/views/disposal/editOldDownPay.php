...
$type = "";
$evidence = "";
if (!empty($downPayRecords)) {
    foreach ($downPayRecords as $record) {
        $id = $record->id;
        $downId = $record->downId;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= base_url('downPay') ?>"><i class="fa fa-dashboard"></i> ติดจ่าย</a></li>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">แก้ไขติดจ่าย</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="addCultivation" action="<?php echo base_url() ?>addNewCultivationMethod" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required date" value="<?= $date ?>" readonly id="date" name="date" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="date">จำนวน</label>
                                <input type="text" class="form-control required" value="<?= $cost ?>" id="cost" name="cost" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="type">ประเภท</label><br>
                                <input type="radio" id="type1" name="type" <?php if ($type === "1") {
                                                                                echo "checked";
                                                                            } ?> value="1">
                                <label for="type">เงินสด</label><br>
                                <input type="radio" id="type2" name="type" <?php if ($type === "2") {
                                                                                echo "checked";
                                                                            } ?> value="2">
                                <label for="type">เงินโอน</label><br>
                            </div>
                            <div class="form-group">
                                <img src="<?php echo base_url($evidence) ?>" alt="image" style="max-width:450px"  ><br>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.messages === "success") {
                    window.location.href = "/downPay/<?= $downId ?>";
                }
            },
